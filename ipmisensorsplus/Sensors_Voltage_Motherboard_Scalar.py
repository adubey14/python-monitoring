class Sensors_Voltage_Motherboard_Scalar(Sensor):
      def __init__(self):
          ...
          if 'pion' not in self.nodename:
             ...
             self.IPMIDevQueryString=['Baseboard 1.8V','Baseboard 5.0V','Baseboard 12V']
      ...
      def senseandlog(self,timestamp):
          ...
          if self.statusCounter==5:
             ...
             try:
                 ...
                 traceback.print_exc(file=sys.stdout)
                 print sys.exc_info()
sensors['Sensors_Voltage_Motherboard_Scalar']= Sensors_Voltage_Motherboard_Scalar()
