class Sensors_Fanspeed_Motherboard_Scalar(Sensor):
      def __init__(self):
          # Configuration parameters common to all sensors
          self.sensor='Fanspeed'
          ...
          if 'pion' not in self.nodename:
             ...
             self.IPMIDevQueryString=['Serverboard Fan1','Serverboard Fan2','Serverboard Fan3']
      ...
      def senseandlog(self,timestamp):
          ...
          for ipmiquery in self.IPMIDevQueryString:
              ...
              try:
                  ...
                  self.status.processPair('LastReadReadingForDeviceInstance'+self.devinst[counter],str(round(reading,3)))
                     ...
                     print "error in running ipmi command in Sensors_Fanspeed_Motherboard_Scalar"
          ...
          if self.statusCounter==5:
             ...
             try:
                 ...
                 traceback.print_exc(file=sys.stdout)
                 print sys.exc_info()
sensors['Sensors_Fanspeed_Motherboard_Scalar']= Sensors_Fanspeed_Motherboard_Scalar()
