class Sensors_Fanspeed_Cpu_Scalar(Sensor):
      def __init__(self):
          ...
          if 'pion' not in self.nodename:
             ...
             self.IPMIDevQueryString=['Processor 1 Fan']
          ...
          for ipmiquery in self.IPMIDevQueryString:
              ...
              try:
                  ...
                  self.status.processPair('LastReadReadingForDeviceInstance'+self.devinst[counter],str(round(reading,3)))
                     ...
                     print 'Problem in senseandlog in '+self.nodename+self.sensor+self.device+self.valuetype
...
sensors['Sensors_Fanspeed_Cpu_Scalar']= Sensors_Fanspeed_Cpu_Scalar()
