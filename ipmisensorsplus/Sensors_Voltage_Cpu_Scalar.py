class Sensors_Voltage_Cpu_Scalar(Sensor):
      def __init__(self):
          ...
          if 'pion' not in self.nodename:
             ...
             self.IPMIDevQueryString=['Proc VCCP']
          ...
          for ipmiquery in self.IPMIDevQueryString:
              ...
              try:
                  ...
                  self.status.processPair('LastReadReadingForDeviceInstance'+self.devinst[counter],str(round(reading,3)))
                     ...
                     print "error in running ipmi command in Sensors_Voltage_Cpu_Scalar"
...
sensors['Sensors_Voltage_Cpu_Scalar']= Sensors_Voltage_Cpu_Scalar()
